...
export function Footer() {
  return (
    <footer className="footerbg relative overflow-x-hidden pb-5 pl-3 pt-6 lg:py-2 lg:pl-0">
      <div className="container mx-auto text-white">
        <div className="mx-auto grid max-w-6xl pt-10 sm:grid-cols-1 md:grid-cols-3">
          <div className="w-full items-center px-3">
            <div className="mb-3 flex w-full lg:justify-center">
              <a href="/" className="inline-block rounded-md">
                <Logo className="h-10 w-auto" />
              </a>
            </div>
          </div>
          <div className="w-full px-3 pt-3 md:pt-0">
            <div className="mb-10 w-full">
              <h4 className="text-dark mb-5 text-lg font-semibold">
                Quick Links
              </h4>
